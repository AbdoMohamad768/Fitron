...
function ProfileInfo() {
  return (
    <div className="flex flex-col items-center px-4 sm:px-6">
      ...
      <div className="w-full min-w-[320px] text-center">
        <div className="bg-[#E8F0E8] flex flex-col sm:flex-row items-center mt-3 mb-5 gap-6 sm:gap-10 px-6 sm:px-10 py-4 rounded-3xl shadow-md">
          {/* Profile Image */}
          <img
        ...
        <div className="mt-6 sm:mt-10 flex flex-col lg:flex-row gap-4 sm:gap-5">
          {/* Column 1 */}
