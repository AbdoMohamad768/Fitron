    ...
    <div className="flex items-center flex-col">
      ...
      <div className="w-full  flex justify-center flex-col items-start p-6 rounded-2xl  bg-[#E8F0E8]"  >
        ...
        <div className="mb-10 flex flex-col">
          ...
          <select name="measurment" id="measurment" className=" w-full md:w-[600px]   sm:min-w-[320px]  bg-white pt-2 pb-2 pl-3" onChange={changeDate} value={measurmentData.measurment}>
        ...
        <div className="flex flex-col mb-10" >
          ...
          <select name="Zone" id="zone" className=" md:w-[600px]   sm:w-[320px] bg-white pt-2 pb-2 pl-3" onChange={changeDate} value={measurmentData.Zone}>
