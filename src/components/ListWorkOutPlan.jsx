  ...
  return (
    <ul className="flex items-center px-3 py-2 bg-white dark:bg-dark-main-750 dark:text-white rounded-xl mt-2 text-sm text-gray-700 gap-3 ">
      <li className="flex items-center gap-2 basis-2/6">
        <span
          className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-semibold ${item.activity === "running"
            ? "bg-circle-icon-blue"
      ...
      <li className="basis-1/6">
        <span
          className={`px-1 py-1 rounded-full text-[10px] md:text-xs font-semibold md:px-2 md:py-1 ${item.status === "complete"
